...
\usepackage{amsmath} % For \max, \text
...
\definecolor{builtinclr}{rgb}{0.35, 0, 0.533}
...
\makeatletter
\newcommand{\resetlinenumber}{\setcounter{ALG@line}{0}}
\makeatother
...
Ravi Madduri\IEEEauthorrefmark{1}\IEEEauthorrefmark{3}
}
\IEEEauthorblockA{
\IEEEauthorrefmark{1}Argonne National Laboratory \quad
\IEEEauthorrefmark{2}University of Massachusetts Amherst \quad
\IEEEauthorrefmark{3}The University of Chicago \\
...
\begin{IEEEkeywords}
Federated Learning, Distributed Machine Learning, Observability, Experiment Tracking, MLflow, Weights and Biases, Map Visualization, Software
\end{IEEEkeywords}
