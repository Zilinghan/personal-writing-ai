...
\hline
C5 & Software code languages, tools, and services used & Python\,$\geq$\,3.8; optional extras: wandb\,$\geq$\,0.16 (Weights \& Biases backend), mlflow\,$\geq$\,2.0 (MLflow backend), requests\,$\geq$\,2.25 (client geolocation helpers); no mandatory third-party dependencies for the core package \\
\hline
...
\hline
S6 & If available, link to user manual & \url{https://appfl.github.io/hivewatch/}; \texttt{README.md} at repository root \\
\hline
